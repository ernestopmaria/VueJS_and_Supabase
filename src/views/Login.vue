<template>
    ...
    <!--Error Handling -->
    <div v-if="errorMsg" class="mb-10 p-4 rounded-mb bg-light-grey">
      <p class="text-red-500">{{errorMsg}}</p>
    </div>

    <!-- Register-->
    <form action="" class="p-8 flex flex-col bg-light-grey rounded-2xl shadow-lg">
      ...
      <router-link class="text-md mt-6 text-center " :to="{name:'Register'}">
        Já não tem uma conta? <span class="underline">Clique aqui</span>
      </router-link>
    </form>
